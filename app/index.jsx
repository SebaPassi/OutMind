...
const Home = () => {
  return (
    <View className="flex-1 items-center justify-center">
      <Image source={{ uri: "https://res.cloudinary.com/davxupqlx/image/upload/v1755867862/OutMind_Logo_icdv2z.png" }} className="my-5 w-32 h-32" />

      <Text className="font-bold text-lg">OutMind</Text>

      <Text className="mb-8 mt-2.5 text-gray-600">Nunca olvides lo que realmente importa.</Text>
